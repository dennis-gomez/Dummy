...
export const useVehicles = () => {
  ...
  const [loading, setLoading] = useState(false);
      ...
      const fields = [
        ...
        { name: "vehicle_type_of_oil", placeholder: "Tipo Aceite", validations: [ (value) => value && value.length > 50 ? "El tipo de aceite debe tener máximo 50 caracteres." : null, ], width: 250, multiline: true, rows: 2 },
        { name: "vehicle_spark_plug_model", placeholder: "Modelo Buj\u00EDa", validations: [(value) => value && value.length > 50 ? "La bujía debe tener máximo 50 caracteres." : null,], width: 250, multiline: true, rows: 2 },
        { name: "vehicle_tires_front", placeholder: "Dimensión Llantas Delanteras", validations: [ (value) => value && value.length > 50 ? "Las llantas delanteras deben tener máximo 50 caracteres." : null, ], width: 250, multiline: true, rows: 2 },
        { name: "vehicle_tires_back", placeholder: "Dimensión Llantas Traseras", validations: [ (value) => value && value.length > 50 ? "Las llantas traseras deben tener máximo 50 caracteres." : null, ], width: 250, multiline: true, rows: 2 },
        { name: "bike_brake_pad", placeholder: "Modelo Pastillas de Freno", validations: [ (value) => value && value.length > 50 ? "Las pastillas de freno deben tener máximo 50 caracteres." : null, ], width: 383, multiline: true, rows: 2 },
        {
          name: "vehicle_color",
          placeholder: "Color",
          validations: [
    ...
    const editFields = [
        ...
        { name: "vehicle_type_of_oil", placeholder: "Tipo Aceite", validations: [ (value) => value && value.length > 50 ? "El tipo de aceite debe tener máximo 50 caracteres." : null, ], width: 150, multiline: true, rows: 2 },
        { name: "vehicle_spark_plug_model", placeholder: "Modelo Buj\u00EDa", validations: [(value) => value && value.length > 50 ? "La bujía debe tener máximo 50 caracteres." : null,], width: 150, multiline: true, rows: 2 },
        { name: "vehicle_tires_front", placeholder: "Dimensión Llantas Delanteras", validations: [ (value) => value && value.length > 50 ? "Las llantas delanteras deben tener máximo 50 caracteres." : null, ], width: 150, multiline: true, rows: 2 },
        { name: "vehicle_tires_back", placeholder: "Dimensión Llantas Traseras", validations: [ (value) => value && value.length > 50 ? "Las llantas traseras deben tener máximo 50 caracteres." : null, ], width: 150, multiline: true, rows: 2 },
        { name: "bike_brake_pad", placeholder: "Modelo Pastillas de Freno", validations: [ (value) => value && value.length > 50 ? "Las pastillas de freno deben tener máximo 50 caracteres." : null, ], width: 150, multiline: true, rows: 2 },
        { 
          name: "vehicle_color", 
          placeholder: "Color", 
          validations: [
